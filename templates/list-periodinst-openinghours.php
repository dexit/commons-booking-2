<?php
	...
	<li id="post-<?php the_ID(); ?>" <?php CB2::post_class( 'cb2-template-available' ); ?>>
		<div class="cb2-details">
			...
			<a class="thickbox" name="opening times" href="?inlineId=periodinst_popup_<?php the_ID(); ?>&amp;title=opening+hours&amp;width=300&amp;height=500&amp;#TB_inline">
		...
		<div id="periodinst_popup_<?php the_ID(); ?>" style="display:none;">
			wahhhh
		</div>
	</li>
<?php } ?>
