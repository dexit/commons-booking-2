...
$Class_context = ( $context_post ? get_class( $context_post ) : 'CB2_PeriodEntity_Timeframe_User' );

if ( $context_post && ! $context_post instanceof CB2_PeriodEntity )
...
// ------------------------------------ Tab nav
CB2::the_nexts( NULL, ( $context_post ? 'cb2-tab-period' : NULL ) );

// ------------------------------------ Period Status Type
print( "<div id='cb2-tab-status'>" );
CB2::the_meta_box( "{$Class_context}_period_status_type", $context_post );
CB2::the_meta_box( "{$Class_context}_status",             $context_post );
print( '</div>' );
...
CB2::the_meta_box( "{$Class_context}_location", $context_post, FALSE ); // $throw_if_not_found = FALSE
CB2::the_meta_box( "{$Class_context}_item",     $context_post, FALSE );
CB2::the_meta_box( "{$Class_context}_user",     $context_post, FALSE );
print( '</div>' );
