...
if ( ! isset( $title ) ) $title = $post_type_object->labels->add_new_item; // CB2/Annesley: title can be controlled
...
if ( apply_filters( 'replace_editor', false, $post ) !== true ) {
	...
	include( dirname( __FILE__ ) . '/edit-form-advanced.php' ); // CB2/Annesley: ABSPATH . 'wp-admin/ removed
}
