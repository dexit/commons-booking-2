...
if ( ! isset( $title ) ) $title = $post_type_object->labels->name; // CB2/Annesley: title can be controlled
...
echo esc_html( $title ); // CB2/Annesley: title can be controlled
?></h1>

<?php
if ( current_user_can( $post_type_object->cap->create_posts ) ) {
	// CB2/Annesley: $add_new_query added
	echo ' <a href="' . esc_url( admin_url( $post_new_file ) . "&$add_new_query" ) . '" class="page-title-action">' . esc_html( $post_type_object->labels->add_new ) . '</a>';
}
