...
abstract class CB2_PeriodItem extends CB2_PostNavigator implements JsonSerializable {
  ...
  // public  static $postmeta_table   = FALSE;
	...
	public static $all_post_types = array(
		...
		'perioditem-user',
		// perioditem-automatic is not a real database post_type
		// it is injected in the PHP layer
		// The WP_Query wpdb redirect system triggers
		// only when there is a managed CB2 post_type in the first position
		//   post_type[0]
		'perioditem-automatic', // also, post_status = auto-draft
	);
