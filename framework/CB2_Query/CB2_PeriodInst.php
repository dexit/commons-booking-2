...
abstract class CB2_PeriodInst extends CB2_PostNavigator implements JsonSerializable {
  ...
  function classes() {
    ...
    $classes .= ( $this->is_top_priority() ? ' cb2-periodinst-no-overlap' : ' cb2-periodinst-has-overlap' );
